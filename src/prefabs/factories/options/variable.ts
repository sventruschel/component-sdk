...
type Attributes = PartialBy<Omit<ValueDefault, RedundantKeys>, 'value'> | Omit<ValueRef, RedundantKeys>;

const defaultAttributes = {
  value: []
}

export const variable = (label: string, attrs: Attributes = {}): OptionProducer => {
  return (key) => ({
    ...defaultAttributes,
    ...attrs,
    key,
